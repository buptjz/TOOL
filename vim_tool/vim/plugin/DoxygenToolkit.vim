...
let g:Doxy_Date = strftime("%Y-%m-%d - %H:%M")


let loaded_DoxygenToolkit = 1

"let s:licenseTag = s:licenseTag . "@fax: +86.10.815.72687 e-mail: taifeng.wjm@taobao.com\<enter>"
"let s:licenseTag = s:licenseTag . "@fax: +86.10.815.72457 e-mail: zhaoyin.zy@taobao.com\<enter>\<enter>"

"echo 'Loading DoxygenToolkit...'
let s:licenseTag = "\<enter>@copyright (c) 2012 Taobao.com, Inc. All Rights Reserved\<enter>"
let s:licenseTag = s:licenseTag . "@author : xiaowen.zl\<enter>"
let s:licenseTag = s:licenseTag . "@fax    : +86.10.815.72428\<enter>"
let s:licenseTag = s:licenseTag . "@e-mail : xiaowen.zl@taobao.com\<enter>"
let s:licenseTag = s:licenseTag . "@date   : ". g:Doxy_Date ."\<enter>"
let s:licenseTag = s:licenseTag . "@version: 1.0.0.1\<enter>"
...
function! <SID>DoxygenLicenseFunc()
  ...
  if !exists("g:DoxygenToolkit_authorName")
    ...
    let g:DoxygenToolkit_authorName = "xiaowen.zl"
  endif
  ...
  if !exists("g:DoxygenToolkit_versionString")
    ...
    let g:DoxygenToolkit_versionString = "1.0.0.1"
  endif
  ...
  exec "normal A".strpart( s:startCommentBlock, 2 ).substitute( g:DoxygenToolkit_licenseTag, "\<enter>", "\<enter>".s:interCommentBlock, "g" )
...
command! -nargs=0 DoxVar     :call <SID>DoxygenBlockVar()
command! -nargs=0 DoxLicense :call <SID>DoxygenLicenseFunc()
